...
import { STAFF_INVITE_V1 } from './staff-invite';
import {
...
export const EMAIL_TEMPLATES: Record<string, EmailTemplate<any>> = {
  ...
  [STAFF_INVITE_V1.key]: STAFF_INVITE_V1,
  ...
  [STAFF_ACCOUNT_REACTIVATED_V1.key]: STAFF_ACCOUNT_REACTIVATED_V1,
};
...
export const NOTIFICATION_TYPE_GROUPS = {
  ...
  INVITE: [PORTAL_INVITE_V1.key, STAFF_INVITE_V1.key],
  APPOINTMENT_UPDATE: [
  ...
  STAFF: [
    STAFF_ROLE_GRANTED_V1.key,
    STAFF_ROLE_REVOKED_V1.key,
    STAFF_ACCOUNT_DEACTIVATED_V1.key,
    STAFF_ACCOUNT_REACTIVATED_V1.key,
  ],
} as const;
