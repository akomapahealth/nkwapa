        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="space-y-2">
            ...
            <p className="max-w-3xl text-sm text-muted-foreground">
              Generate de-identified research packs with stable clinic-scoped keys,
              15-minute timestamp rounding, and automatic sync to the private GitHub
              research repository.
            </p>
          </div>
              ...
              <div className="rounded-2xl border border-emerald-200 bg-emerald-50/80 p-4 text-sm text-emerald-950">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p>
                      Stable patient keys, rounded timestamps, no names or free text,
                      no raw payload JSON, and only research-safe fields in the export.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <DialogContent className="max-w-lg rounded-[28px] border-border/80">
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={!rejectReason.trim() || (rejectTarget ? actionLoadingId === rejectTarget.id : false)}
              >
