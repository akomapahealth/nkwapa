    ...
    <RouteGuard requiredPermission="PATIENT.CREATE">
      <div className="space-y-6">
        ...
        <AppPageHeader
          ...
          description="Capture a complete demographic record for this clinic while checking for duplicates before the patient enters care."
        />
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <AppMetricCard
            ...
            value="Clinic"
            icon={UserPlus}
            detail="The patient will be created directly inside this clinic workflow."
          />
          <AppMetricCard
            title="Duplicate check"
            value="Enabled"
            icon={ShieldCheck}
            detail="National ID matching helps prevent accidental duplicate charts."
          />
          <AppMetricCard
            title="Workflow"
            value="Guided"
            icon={FilePenLine}
            detail="Complete the form once, then move straight into the patient record."
          />
        </div>
        ...
        <Card className="max-w-4xl rounded-[28px] border-border/80 bg-card/90 shadow-lg shadow-black/5">
          <CardHeader>
            ...
            <CardDescription>
              Enter demographics, contact details, and national ID information for the patient.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button variant="outline" asChild className="rounded-2xl">
                  <Link href={`/clinics/${clinicId}/patients`}>Cancel</Link>
                </Button>
              </div>
            </form>
          </CardContent>
