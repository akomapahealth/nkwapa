    ...
    <RouteGuard requiredPermission="RESEARCH.SETTINGS.UPDATE">
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <AppMetricCard
            title="Last updated"
            value={settings?.updatedAt ? new Date(settings.updatedAt).toLocaleDateString() : "Not set"}
            icon={Settings2}
            detail={
        ...
        <Card className="max-w-3xl rounded-[28px] border-border/80 bg-card/90 shadow-lg shadow-black/5">
          <CardHeader>
            ...
            <CardDescription>
              Configure whether the active clinic participates in research workflows and how approvals are enforced.
            </CardDescription>
          </CardHeader>
            ...
            <div className="rounded-2xl border border-border/70 bg-background/80 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Keep a director checkpoint in place before each export leaves the clinic workspace.
                  </p>
                </div>
              </div>
            </div>
