      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-6 md:grid-cols-2 lg:px-8">
        <div>
          ...
          <p data-animate className="mt-6 font-landing-body text-base text-[#475569]">
            We are grateful for each partner that has supported the development of Nkwapa. From
            providing clinical feedback to funding infrastructure, there are many ways to get
            involved.
          </p>
          <a
            data-animate
        ...
        <div className="space-y-5">
          {partners.map((p) => (
            ...
            >
              ...
              <p className="mt-2 font-landing-body text-sm text-[#475569]">{p.description}</p>
            </div>
          ))}
        </div>
      </div>
