          ...
          {QUOTES.map((t) => (
            ...
            >
              <CardContent className="pt-8">
                <p className="font-landing-body text-sm leading-relaxed text-foreground">&ldquo;{t.quote}&rdquo;</p>
                <div className="mt-6 border-t border-border pt-4">
                  <p className="font-landing-heading text-sm font-semibold text-foreground">{t.name}</p>
