...
Volunteer flow
	...
	2.	Create encounter
	3.	Record vitals:
	•	systolic/diastolic, HR, weight, height
	4.	Record diabetes screening:
	•	glucose value + type + symptoms
	5.	System computes BP classification (simple rule)
	6.	Submit to preceptor → encounter moves to IN_REVIEW
