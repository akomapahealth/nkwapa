...
| `docs/specs/14_CHRONIC_DISEASE_INTERVIEWS.md`               | Current with follow-on work | Guided hypertension and diabetes interviews, server-side derivation, clinician boundary, generated note, and the approved clinical thresholds |
