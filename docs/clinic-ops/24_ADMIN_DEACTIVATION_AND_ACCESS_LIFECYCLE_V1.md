# 24. Admin Deactivation And Access Lifecycle V1

## Status

Implemented baseline.

Clinic-scoped and global lifecycle actions exist in the current codebase. Treat this document as the original design reference, not the only source of truth.
