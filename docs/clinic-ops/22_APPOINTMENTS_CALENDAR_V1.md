...
The current codebase supports appointment requests, confirmation/rejection, and appointment persistence. Richer staff calendar UX, rescheduling, and deeper lifecycle handling remain follow-on work.
